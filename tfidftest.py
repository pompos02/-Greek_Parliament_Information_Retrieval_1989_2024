...
def main():
    ...
    for chunk in reader:
        ...
        chunk_preprocessed = list(preprocess_documents_chunk(
            ...
            n_process=4         # Set to 1 to reduce memory usage
        ))
    ...
    preprocessed_df = pd.read_pickle('preprocessed_chunks/preprocessed_chunk_0.pkl')
    print(preprocessed_df.head())
    print(vectorizer.get_feature_names_out()[:100])  # Display first 10 features
    print(tfidf_matrix.shape)  # Should be (10000, 10000) based on your vectorizer settings

    print("SPEECH IDS: ",speech_ids[:10])  # Display first 10 IDs
